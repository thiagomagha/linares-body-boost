      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {celebrities.map((celebrity) => (
            <div key={celebrity.name} className="relative group">
              ...
              <div className="absolute top-3 right-3">
                <div className="bg-fitness-green text-white text-xs font-bold px-2 py-1 rounded-full flex items-center gap-1">
                  <Check className="h-3 w-3" /> CLIENTE REAL
                </div>
              </div>
            </div>
          ))}
